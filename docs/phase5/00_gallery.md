...
Everything below comes from two functions — `pp.field()` to extract the data,
`pl.plot()` to draw it. Click a card for the recipe.
  ...
  <div class="gallery-card">
    <a href="../step53_horizontal_section/" style="text-decoration: none; color: inherit; display: block;">
      ...
      <div style="padding: 15px; background-color: #fafafa; text-align: center;">
        ...
        <p style="margin: 0; font-size: 1em; color: #666;">The upwelling front, with the wind stress that drives it</p>
      </div>
    </a>
  </div>
  ...
  <div class="gallery-card">
    <a href="../step53_horizontal_section/" style="text-decoration: none; color: inherit; display: block;">
      ...
      <div style="padding: 15px; background-color: #fafafa; text-align: center;">
        ...
        <p style="margin: 0; font-size: 1em; color: #666;">Water-mass structure across the shelf</p>
      </div>
    </a>
  </div>
  ...
  <div class="gallery-card">
    <a href="../step53_horizontal_section/" style="text-decoration: none; color: inherit; display: block;">
      ...
      <div style="padding: 15px; background-color: #fafafa; text-align: center;">
        ...
        <p style="margin: 0; font-size: 1em; color: #666;">The pressure field behind the geostrophic flow</p>
      </div>
    </a>
  </div>
  ...
  <div class="gallery-card">
    <a href="../step53_horizontal_section/" style="text-decoration: none; color: inherit; display: block;">
      ...
      <div style="padding: 15px; background-color: #fafafa; text-align: center;">
        ...
        <p style="margin: 0; font-size: 1em; color: #666;">Normalised by <em>f</em> — where the eddies are</p>
      </div>
    </a>
  </div>
  ...
  <div class="gallery-card">
    <a href="../step53_horizontal_section/" style="text-decoration: none; color: inherit; display: block;">
      ...
      <div style="padding: 15px; background-color: #fafafa; text-align: center;">
        ...
        <p style="margin: 0; font-size: 1em; color: #666;">Any field shaded, with vorticity contoured over it</p>
      </div>
    </a>
  </div>
  ...
  <div class="gallery-card">
    <a href="../step53_horizontal_section/" style="text-decoration: none; color: inherit; display: block;">
      ...
      <div style="padding: 15px; background-color: #fafafa; text-align: center;">
        ...
        <p style="margin: 0; font-size: 1em; color: #666;">The same maps at 100 m, or wherever you ask</p>
      </div>
    </a>
  </div>
  ...
  <div class="gallery-card">
    <a href="../step59_animations/" style="text-decoration: none; color: inherit; display: block;">
      ...
      <div style="padding: 15px; background-color: #fafafa; text-align: center;">
        ...
        <p style="margin: 0; font-size: 1em; color: #666;">Watch the forecast evolve, as maps or sections</p>
      </div>
    </a>
  </div>
