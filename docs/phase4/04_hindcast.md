...
| Atmosphere source   | GFS (online)                      | **GFS** reanalysis (online, ECMWF format) |
...
GLORYS+GFS hindcast config for a region, proven a single run, and run a
...
estimates of the _past_ ocean (GLORYS) and atmosphere (GFS). You run a long
